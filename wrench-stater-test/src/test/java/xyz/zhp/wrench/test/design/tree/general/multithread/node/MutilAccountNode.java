...
import xyz.zhp.wrench.test.design.tree.general.multithread.node.last.MultiMemberLevel1Node;
import xyz.zhp.wrench.test.design.tree.general.multithread.node.last.MultiMemberLevel2Node;
...
//    @Resource
    private ThreadPoolExecutor threadPoolExecutor =  ExecutorBuilder.create()//
            .setCorePoolSize(1)//
            .setMaxPoolSize(1)//
            .setKeepAliveTime(0)//
            .build();
